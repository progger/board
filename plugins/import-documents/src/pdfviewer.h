...
public:
  explicit PdfViewer(QQuickItem *parent = nullptr);
  ~PdfViewer() override;
  ...
  qreal imageWidth() const { return _image_width; }
  qreal imageHeight() const { return _image_height; }
public slots:
